...
var z = Wu.exports;
const wl = ({ text: e }) =>
    z.jsx("button", { className: "headerButton", children: e }),
  Nc = () =>
    z.jsxs("div", {
      className: "homeHeader",
      children: [
        z.jsx("img", { src: "src/assets/header-icon.svg", alt: "" }),
        z.jsxs("div", {
          className: "group-headerButton",
          children: [
            z.jsx(wl, { text: "Início" }),
            z.jsx(wl, { text: "Sobre" }),
            z.jsx(wl, { text: "Contato" }),
          ],
        }),
      ],
    }),
    ...
    z.jsxs("section", {
      ...
      children: [
        z.jsxs("div", {
          ...
          children: [
            z.jsx("img", {
              src: "src/assets/profile-arrow.svg",
              alt: "Seta de perfil",
            }),
            z.jsx("p", { children: "Olá! Eu sou " }),
            z.jsx("p", {
              style: { color: "#7127BA" },
              children: "Yuri Matthewus",
            }),
          ],
        }),
        z.jsxs("div", {
            ...
            z.jsxs("div", {
              ...
              children: [
                z.jsx("p", {
                  ...
                  children: "Programadores e artistas",
                }),
                z.jsxs("span", {
                ...
                z.jsx("p", {
                  className: "profession-subtitle",
                  children: "a própria profissão.",
                }),
              ],
            }),
          ],
        ...
        z.jsxs("div", {
          ...
          children: [
            z.jsxs("span", {
              children: [
                "Full Stack developer e mobile.",
                z.jsx("span", { className: "blink", children: "|" }),
                " ",
              ],
            }),
            z.jsx("p", { children: "Atualmente trabalhando como freelancer." }),
          ],
        }),
        z.jsx("div", {
          className: "about-me",
  ...
  zc = () =>
    z.jsx("div", {
      ...
      children: z.jsx("p", { children: "Experiência" }),
    }),
  Lc = () =>
    z.jsxs("div", {
      className: "home-body",
      children: [z.jsx(Pc, {}), z.jsx(zc, {})],
    }),
  Tc = () =>
    z.jsxs(z.Fragment, {
      children: [
        z.jsx("header", { children: z.jsx(Nc, {}) }),
        z.jsx("body", { children: z.jsx(Lc, {}) }),
      ],
    });
function Rc() {
  return z.jsx("section", { children: z.jsx(Tc, {}) });
}
var Ql = {},
  ns = { exports: {} },
  ge = {},
...
function Qc(e, n, t, r, l, o, i, u, s) {
  (Et = !1), (Tr = null), Hc.apply(Wc, arguments);
}
...
function Es(e) {
  return (e = Yc(e)), e !== null ? xs(e) : null;
}
function xs(e) {
...
function ei(e, n, t, r) {
  if (Mr) {
    var l = co(e, n, t, r);
    if (l === null) Ml(e, n, r, Dr, t), Xi(e, r);
...
var Dr = null;
function co(e, n, t, r) {
  if (((Dr = null), (e = Zo(r)), (e = Sn(e)), e !== null))
...
var ot = {
  ...
  Ji = we(nl),
  df = V({}, nl, { dataTransfer: 0 }),
  pf = we(df),
  mf = V({}, Gt, { relatedTarget: 0 }),
  Pl = we(mf),
...
var Cf = V({}, Gt, {
  ...
  zf = we(Pf),
  Lf = V({}, ot, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Tf = we(Lf),
  Rf = V({}, nl, {
    deltaX: function (e) {
...
var Mf = We && "TextEvent" in window && !xt,
  Is = We && (!li || (xt && 8 < xt && 11 >= xt)),
  eu = " ",
  nu = !1;
function Fs(e, n) {
  switch (e) {
...
function Vs(e) {
  if (e.propertyName === "value" && tl(It)) {
    var n = [];
    $s(n, It, e, Zo(e)), Ss(Uf, n);
  }
}
function Af(e, n, t) {
  e === "focusin"
    ? (lu(), (Ct = n), (It = t), Ct.attachEvent("onpropertychange", Vs))
    : e === "focusout" && lu();
}
function Vf(e) {
...
for (var Rl = 0; Rl < su.length; Rl++) {
  var jl = su[Rl],
    Yf = jl.toLowerCase(),
    Xf = jl[0].toUpperCase() + jl.slice(1);
  pn(Yf, "on" + Xf);
}
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = jt(a, f)), v != null && S.push($t(a, v, d)))),
            F)
          )
            break;
          a = a.return;
...
var yo = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  bf =
    typeof queueMicrotask == "function"
      ...
      : typeof du < "u"
      ? function (e) {
          return du.resolve(null).then(e).catch(ed);
        }
      : yo;
function ed(e) {
  setTimeout(function () {
...
function hn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Cs(Jo, hn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function gi(e, n, t, r, l, o) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (xr.current = e === null || e.memoizedState === null ? ad : cd),
    (e = t(r, l)),
    Nt)
  ) {
    o = 0;
...
function sd(e, n, t) {
  ...
  if (Ca(e)) _a(n, l);
    ...
    (t = oa(e, n, l, r)),
      t !== null && ((l = ie()), je(t, e, r, l), Na(t, n, r));
  }
}
function Ca(e) {
  var n = e.alternate;
...
function md(e, n, t, r, l, o, i) {
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (o = Error(y(419))), (r = Vl(o, r, void 0)), pr(e, n, i, r);
  }
...
function vd(e, n, t) {
  ...
  switch ((ui(n), n.tag)) {
    ...
    case 4:
      return (
        nt(), To(e, n), e === null && Ut(n.stateNode.containerInfo), te(n), null
      );
    case 10:
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[go], delete n[nd], delete n[td])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function je(e, n, t, r) {
  ...
  Xt(e, t, r),
    (!(j & 2) || e !== J) &&
      (e === J && (!(j & 2) && (al |= t), X === 4 && be(e, b)),
      pe(e, r),
      t === 1 && j === 0 && !(n.mode & 1) && ((rt = Q() + 500), ol && hn()));
}
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Yi(t), n === 1))
      e.tag === 0 ? rd($u.bind(null, e)) : bs($u.bind(null, e)),
        bf(function () {
          !(j & 6) && hn();
        }),
        (t = null);
...
function Jr(e, n) {
  ...
  while (!0);
  if ((ci(), (j = t), (Xr.current = r), K !== null)) throw Error(y(261));
  return (J = null), (b = 0), X;
}
function xd() {
  for (; K !== null; ) Ya(K);
...
function wn(e, n, t) {
  var r = O,
    l = xe.transition;
  try {
    (xe.transition = null), (O = 1), _d(e, n, t, r);
  } finally {
    (xe.transition = l), (O = r);
  }
  return null;
  ...
  if (nn !== null) {
    ...
    try {
      if (((xe.transition = null), (O = 16 > e ? 16 : e), nn === null))
        ...
        if (((e = nn), (nn = null), (Zr = 0), j & 6)) throw Error(y(331));
        var l = j;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qo(n, t | 1), pe(n, Q()), !(j & 6) && ((rt = Q() + 500), hn()));
      }
      break;
    case 13:
      Ln(function () {
...
gs = Ni;
ws = Ln;
var Dd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, vs, ys, Ni] },
  vt = {
...
Ql.createRoot(document.getElementById("root")).render(
  z.jsx(wc.StrictMode, { children: z.jsx(Rc, {}) })
);
